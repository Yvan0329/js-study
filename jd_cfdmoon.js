...
function cashOutQuali() {
  return new Promise((resolve) => {
    ...
    // dwIsRandHb=0&
    // ddwVirHb=100&
    // strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTA5&
    // dwExchangeType=0&

    // _stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&
    // _ste=1&
    // h5st=20210919151008760%3B7126046191212161%3B10032%3Btk01w78d91af330n9pBFHlgeoUGF13Nx6GPx4ELWT8a%2FQxLOjaEkrzIdFRSHB6X62qVt1pgEd4nUANZjP8JGWV0b0oLe%3B9d416d63697896165c33d90cd711d270b0f91d3f6da818a21dc971a335f85422
    // &_=1632035408766
    // &sceneval=2
    // &g_login_type=1&
    // callback=jsonpCBKO&
    // g_ty=ls
    console.log(`抢购时间：` + nowTimes.getHours() + nowTimes.getMinutes() + "：" + nowTimes.getSeconds() + ":" + nowTimes.getMilliseconds())
    $.get(taskUrl(`user/ExchangePearlHb`, `dwLvl=8&dwIsRandHb=0&ddwVirHb=1000&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTA5&dwExchangeType=0`), (err, resp, data) => {
      try {
        if (err) {
...
function taskUrl(function_path, body = '', dwEnv = 7) {
  ...
  // callback=jsonpCBKO&
  // g_ty=ls
  let url = `${JD_API_HOST}jxbfd/${function_path}?__t=${Date.now()}&strZone=jxbfd&ptag=138631.26.55&${body}&__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1`;
