...
!(async () => {
    ...
    // cookiePk[0] = "pt_key=AAJhcM-RADBE2hlAQql_0rb1PGqz64wOttv4ZQ8yJBSDD6y6bzYEDdWA5j1BR8K2MxUQW4lAhTo;pt_pin=1808746762-486237;"
    ...
    for (let i = 0; i < cookiePk.length; i++) {
        ...
        if ($.memberListLength < 5) {
            for (let i = 70; i < cookiesArr.length; i++) {
                if ($.memberListLength == 5) {
                    break;
                }
                console.log("执行加入队伍")
