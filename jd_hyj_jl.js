...
function jinli() {
    let body = {
        "ss": {"extraData": {"log": "", "sceneid": "HYGJZYh5"}, "secretp": $.secretp1, "random": "32827547"},
        "inviteId": "TJASTT0225KkcRkpL9lHfIRPzwfYJfQCjRWnoaRzTcjeQOc"
    }
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.code === 0) {
                            if (data.data && data['data']['bizCode'] === 0) {
                                $.secretp1 = data.data.result.homeMainInfo.secretp
                            }
                        } else {
