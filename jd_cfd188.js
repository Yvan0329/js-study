...
function cashOutQuali() {
  return new Promise((resolve) => {
    ...
    $.get(taskUrl(`user/ExchangePrize`, `dwType=3&dwLvl=12&ddwPaperMoney=18800&strPoolName=jxcfd2_exchange_hb_202108&strPgtimestamp=${token['timestamp']}&strPhoneID=${token['phoneid']}&strPgUUNum=${token['farm_jstoken']}`), (err, resp, data) => {
      try {
        if (err) {
